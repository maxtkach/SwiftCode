    ...
    >
      <nav className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          {/* Логотип */}
          <Link href={`${process.env.NODE_ENV === 'production' ? '/SwiftCode' : ''}/`} className="flex items-center gap-2">
          ...
          <div className="hidden md:flex items-center gap-8">
            <Link href={`${process.env.NODE_ENV === 'production' ? '/SwiftCode' : ''}/`} className="text-text/70 hover:text-accent transition-colors">
              {t('nav.home')}
            </Link>
            ...
            <Link href={`${process.env.NODE_ENV === 'production' ? '/SwiftCode' : ''}/contact`} className="text-text/70 hover:text-accent transition-colors">
              {t('nav.contact')}
            </Link>
          ...
          {isMenuOpen && (
            ...
            >
              <div className="py-4 space-y-4">
                <Link href={`${process.env.NODE_ENV === 'production' ? '/SwiftCode' : ''}/`} className="block text-text hover:text-primary transition-colors">
                  {t('nav.home')}
                </Link>
                ...
                <Link href={`${process.env.NODE_ENV === 'production' ? '/SwiftCode' : ''}/contact`} className="block text-text hover:text-primary transition-colors">
                  {t('nav.contact')}
                </Link>
